...
allowedOptions['datasample'] = ['QCD','DYToMuMu','GluGluToHToGG']
...
process.multiTrackValidator.label = ['cutsRecoTracks','FirstVertexTrackCollection1st','FirstVertexTrackCollectionAll']
