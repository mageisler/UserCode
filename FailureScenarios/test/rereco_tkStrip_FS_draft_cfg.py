...
secFiles.extend( [
        'file:/user/geisler/FS2011/RAW/RelValMinBias_CMSSW_4_2_0_pre4_MC_42_V1-v1_GEN-SIM-DIGI-RAW-HLTDEBUG.root'
] ); 
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('QCD_Pt-15to3000_TuneZ2_Flat_7TeV_pythia6_PU_S6-START44_RERECO_DRAFT.root'),
