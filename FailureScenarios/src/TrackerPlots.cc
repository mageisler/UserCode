...
// $Id: TrackerPlots.cc,v 1.1 2011/11/21 17:36:07 mgeisler Exp $
//
//
...
TrackerPlots::endJob() 
{
          sprintf(savename_png,"../pictures/%s_TrackerMap.png",fileName_.c_str());
	  tkmap->save(true,0,0,savename_png);  
}
