...
# with command line options: tkStrip_fs08 -s SIM,DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,RECO,ENDJOB --no_exec -n -1 --filein file:/tmp/mgeisler/QCD_Pt_15to3000_TuneZ2_Flat_8TeV_pythia6_GEN-SIM_FS08.root --fileout file:/tmp/mgeisler/fs_08_test.root --process RECO --conditions auto:startup
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/tmp/mgeisler/QCD_Pt_15to3000_TuneZ2_Flat_8TeV_pythia6_GEN-SIM_FS08.root')
)
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/mgeisler/fs_08_test.root'),
