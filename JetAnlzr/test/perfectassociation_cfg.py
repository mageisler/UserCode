...
OutfileAnlzr = "PerfectAssociation"
    	
if len(sys.argv)>2:
		
    argBegin = 2

    if "perfectassociation" in str(sys.argv[0]):
        argBegin=1	
...
process.source.fileNames = cms.untracked.vstring('file:/user/geisler/QCD_Pt-600to800_TuneZ2_7TeV_PU_S6_START44_GEN-SIM-RECODEBUG.root')
...
process.perfectTracks1 = cms.EDProducer('PerfectAssociation',
	...
	genParticles = cms.InputTag('genParticles'),
    	...
    	AssociationType = cms.int32(1),
)
		
process.perfectTracks2 = cms.EDProducer('PerfectAssociation',
	PFCandidateCollection = cms.InputTag('particleFlow'),
	trackCollection = cms.InputTag('generalTracks'),
	genParticles = cms.InputTag('genParticles'),
    	TrackingParticles = cms.InputTag("mergedtruth","MergedTrackTruth"),
    	BeamSpot = cms.InputTag("offlineBeamSpot"),
    	VertexCollection = cms.InputTag('selectedPrimaryVertexQuality'),
    	AssociationType = cms.int32(2),
)
		
process.perfectTracks3 = cms.EDProducer('PerfectAssociation',
	PFCandidateCollection = cms.InputTag('particleFlow'),
	trackCollection = cms.InputTag('generalTracks'),
	genParticles = cms.InputTag('genParticles'),
    	TrackingParticles = cms.InputTag("mergedtruth","MergedTrackTruth"),
...
process.perfectJets1 = ak5PFJets.clone(
	src = cms.InputTag("perfectTracks1")
)

process.perfectJets2 = ak5PFJets.clone(
	src = cms.InputTag("perfectTracks2")
)

process.perfectJets3 = ak5PFJets.clone(
	src = cms.InputTag("perfectTracks3")
)
...
process.priorstuff = cms.Sequence(
	...
	process.perfectTracks1 * 
	process.perfectTracks2 * 
	process.perfectTracks3
)
		
##sequence to produce  the jet collection
process.jets = cms.Sequence(
	process.perfectJets1 *
	process.perfectJets2 *
	process.perfectJets3  
)
